...
const ProfilePage = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-pink-50/30 to-purple-50/30 pb-20 md:pb-8">
            ...
            <div className="container mx-auto px-4 max-w-6xl space-y-8">
                ...
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                        {/* Orders Card */}
                        <Link to="/orders" className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-pink-200 transition-all duration-300 transform hover:-translate-y-1">
                            ...
                            <h3 className="font-bold text-gray-900 text-lg mb-1">My Orders</h3>
                            <p className="text-sm text-gray-500 mb-3">Track & manage orders</p>
                        ...
                        {/* Addresses Card */}
                        <Link to="/addresses" className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-pink-200 transition-all duration-300 transform hover:-translate-y-1">
                            ...
                            <h3 className="font-bold text-gray-900 text-lg mb-1">Addresses</h3>
                            <p className="text-sm text-gray-500 mb-3">Manage delivery locations</p>
                            <div className="flex items-center text-pink-600 text-sm font-medium">
                        ...
                        {/* Settings Card */}
                        <div className="group bg-white p-6 rounded-2xl shadow-sm border border-gray-100 hover:shadow-xl hover:border-pink-200 transition-all duration-300 transform hover:-translate-y-1 cursor-pointer">
                            ...
                            <p className="text-sm text-gray-500 mb-3">Privacy & preferences</p>
                            <div className="flex items-center text-pink-600 text-sm font-medium">
